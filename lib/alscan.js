...
var alscan = {
    ...
    addFeedback : function (agent) {
        if (alscan.feedbackAgents.indexOf(agent) < 0) {
            if (alscan.debug) { console.log('addFeedback: ' + agent); }
    ...
    sendFeedback : function () {
        if (alscan.agentDB && alscan.feedbackUrl &&
            ...
            if (alscan.debug) { console.error('sendFeedback: feedbackAgents=' + util.inspect(alscan.feedbackAgents)); }
    ...
    main: function () {
        ...
        args.parse(process.argv.slice(2), function (errors, options) {
            ...
            if (options['--feedback-type'].value == 'unknowns') {
                ...
                alscan.feedbackCheck = function () { return false; };
            } else {
                alscan.feedbackCheck = function () { return true; };
            }

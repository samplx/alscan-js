...
AccessLogEntry.prototype.parse = function (str) {
    ...
    if (fields != null) {
//        console.log("matched combinedRegExp");
//        console.dir(fields);
        this.line       = fields[0];
        this.host       = fields[1];
        this.ident      = fields[2];
        ...
        if (fields != null) {
//            console.log("matched commonRegExp");
//            console.dir(fields);
            this.line       = fields[0];
            this.host       = fields[1];
            this.ident      = fields[2];
...
//    console.log("Timestamp: year="+year+", month="+month+", day="+day+", hours="+hours+", minutes="+minutes+", seconds="+seconds+", timezone="+timezone);
